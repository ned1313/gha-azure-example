...
Howdy there! These are the demo files to accompany the [Terraform Code with GitHub Actions blog post on env0's website](TODO). This demo includes the following:

* Terraform code to deploy a VNET on Microsoft Azure
...
The code in the `setup` directory will create the following for you:
